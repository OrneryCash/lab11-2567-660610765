...
export default function RegisterForm() {
  ...
  useEffect(checkAllExtra, [buyBottle, buyShoes, buyCap])

  const checkIsUserAgreed = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div>
        ...
        {allExtra && <span className="text-success d-block">(20% Discounted)</span>}
      </div>

      {/* Terms and conditions */}
      <div>
        <input className="me-2" type="checkbox" onChange={checkIsUserAgreed} />I agree to the terms and
        conditions
      </div>
